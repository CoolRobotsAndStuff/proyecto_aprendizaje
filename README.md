...
1. Instalar python version >= 3.13.5. Se puede checkear con ```python --version```.

1. Clonar este repositorio y entrar al directorio base.

1. Instalar dependencias de R con el siguiente comando:
...
1. Entrar a http://localhost:8000 desde cualquer buscador.
